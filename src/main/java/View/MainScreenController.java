...
public class MainScreenController implements IView, Initializable, Observer {
    ...
    private void playWinSound() {
        Media sound = new Media(new File("src/main/resources/Sound/win.mp3").toURI().toString());
    ...
    private void playerMoveSound() {
        Media sound = new Media(new File("src/main/resources/Sound/move.wav").toURI().toString());
    ...
    private void playerWrongMoveSound() {
        Media sound = new Media(new File("src/main/resources/Sound/wrongMove.mp3").toURI().toString());
        MediaPlayer mediaPlayer1 = new MediaPlayer(sound);
        mediaPlayer1.play();
    }
    ...
    private void errorSound() {
        Media sound = new Media(new File("src/main/resources/Sound/error.MP3").toURI().toString());
        MediaPlayer mediaPlayer1 = new MediaPlayer(sound);
        mediaPlayer1.play();
    }
