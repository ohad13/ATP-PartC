...
public class MazeDisplayer extends Canvas {
    ...
    private void draw() {
        if (maze != null) {
            ...
            try {
                wallImage = new Image(getClass().getClassLoader().getResourceAsStream("Image/coronaWall2.png"));
                playerImageR = new Image(getClass().getClassLoader().getResourceAsStream("Image/coronaPlayer1R.png"));
                //playerImageL = new Image(getClass().getClassLoader().getResourceAsStream("Image/coronaPlayer1L.png"));
                goalImage = new Image(getClass().getClassLoader().getResourceAsStream("Image/coronaGoal1.png"));
            } catch (Exception e) {
    ...
    public void drawSol(ArrayList<AState> solution) throws FileNotFoundException {
        Image maskImage = new Image(getClass().getClassLoader().getResourceAsStream("Image/mask.png"));
        double canvasHeight = getHeight();
        double canvasWidth = getWidth();
        int rows = maze.getNumOfRow();
        int cols = maze.getNumOfCol();
